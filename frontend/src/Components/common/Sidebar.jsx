        ...
        <>
            <div className={cx('sideBarContainer')}>
                ...
                <div className={cx('sideIcon')}>
                    ...
                    <UilChart className={cx('sideContents')} id={2} style={contentsColor ? {color:'#2f2f2f50'} : {color:'#6563FF'}} onClick={sideColorClick}/>
                    <UilUserSquare className={cx('sideProfile')} id={3} style={profileColor ? {color:'#2f2f2f50'} : {color:'#6563FF'}} onClick={sideColorClick}/>
                    <UilSetting className={cx('sideSetting')} id={4} style={settingColor ? {color:'#2f2f2f50'} : {color:'#6563FF'}} onClick={sideColorClick}/>
                    <UilBell className={cx('sideNotification')} id={5} style={notificationColor ? {color:'#2f2f2f50'} : {color:'#6563FF'}} onClick={sideColorClick}/>
                </div>
