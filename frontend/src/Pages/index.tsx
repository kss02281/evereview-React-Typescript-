...
export { default as AllFeedBackPage } from "./DetailPage/AllFeedBackPage";
export { default as PosFeedBackPage } from "./DetailPage/PosFeedBackPage";
export { default as NegFeedBackPage } from "./DetailPage/NegFeedBackPage";
